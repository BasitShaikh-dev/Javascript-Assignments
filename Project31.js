...
let user = ["Hassan","Jamal","Haroon","Usman","Arbaz"];
let newuser = ["eric","laura","John","Usman","Arbaz"];

for(let u in user){
    for(let nu in newuser){
        if(user[u] = newuser[nu]){
            console.log("yeh wala naam hai koi aur naam dalo");
        }else{
            console.log("ghalat");
        }
    }
